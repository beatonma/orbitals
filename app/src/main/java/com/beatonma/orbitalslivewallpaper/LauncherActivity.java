...
import com.beatonma.orbitalslivewallpaper.dream.DreamPrefsActivity;
import com.beatonma.orbitalslivewallpaper.livewallpaper.LwpPrefsActivity;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				case 0:
					// Wallpaper options
					i = new Intent(com.beatonma.orbitalslivewallpaper.LauncherActivity.this, LwpPrefsActivity.class);
					startActivity(i);
					break;
				case 1:
					// Daydream options
					i = new Intent(com.beatonma.orbitalslivewallpaper.LauncherActivity.this, DreamPrefsActivity.class);
					startActivity(i);
					break;
				case 2:
                    try {
